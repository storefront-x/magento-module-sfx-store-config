 ...
 */
class Url extends DataObject implements UrlInterface
{
    /**
    ...
    public function __construct(
        ...
        SfxStoreConfigInterface $sfxStoreConfig,
        ...
        $this->sfxStoreConfig = $sfxStoreConfig;
        $this->_scopeType = $scopeType;
        $this->hostChecker = $hostChecker ?: $objectManager
    ...
    public function getBaseUrl($params = [])
    {
        ...
        //Changing getBaseURL (Magento native frontend) to getSfxURL - URL of StoreFront X
        $result = $this->sfxStoreConfig->getSfxUrl($this->_getScope()->getCode());
